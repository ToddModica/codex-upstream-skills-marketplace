...
| scipilot-writing-skill | [v1.0.0](https://github.com/Haojae/scipilot-writing-skill) | 学术写作与润色 + 写作质量证据链 |
| scipilot-review-skill | 规划中 | AI 模拟审稿 |
| scipilot-figure-skill | [v2.1.0](https://github.com/Haojae/scipilot-figure-skill) | 科研数据可视化顾问 + 绘制 |
...
| scipilot-writing-skill | [v1.0.0](https://github.com/Haojae/scipilot-writing-skill) | Writing & polishing + writing-quality evidence chain |
| scipilot-review-skill | Planned | AI peer-review simulation |
| scipilot-figure-skill | [v2.1.0](https://github.com/Haojae/scipilot-figure-skill) | Visualization advisor + renderer |
